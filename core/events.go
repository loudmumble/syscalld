// Package core provides the foundational types for the eBPF sensor framework.
//
...
// management. This package is consumed by Sentinel, Agora, and Aegis.
package core
...
// security-relevant system calls monitored by the framework.
...
type Event interface {
	...
	GetEventType() string
	// ToSentinelEvent maps the event to Sentinel's probe event format.
	ToSentinelEvent() map[string]interface{}
	// ToMalscopeEvent maps the event to Malscope's BehaviorEvent format.
...
// ToSentinelEvent maps to Sentinel's probe event format.
...
// ToMalscopeEvent maps to Malscope's BehaviorEvent format.
...
// ToSentinelEvent maps to Sentinel's SyscallEvent format.
...
// ToMalscopeEvent maps to Malscope's SyscallEvent format.
...
// ToSentinelEvent maps to Sentinel's ProcessEvent format.
...
// ToSentinelEvent maps to Sentinel's FileEvent format.
...
// ToSentinelEvent maps to Sentinel's NetworkEvent format.
...
// ToSentinelEvent maps to Sentinel event dict.
...
// ToMalscopeEvent maps to Malscope BehaviorEvent format.
